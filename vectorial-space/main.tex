...
\begin{enumerate}
  ...
  \item $ H $ es cerrado bajo la multiplicación por escalares. Esto es, para cada $ u $ en $ H $ y cada escalar $ c $, el vector $cu$ está en $ H $
\end{enumerate}
...
de otro, y la frase subespacio de $ V $ identifica a $ V $ como el espacio más grande. (David C. Lay, 2007, p. 220)
